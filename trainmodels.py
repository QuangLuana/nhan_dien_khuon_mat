...
training_set=train_datagen.flow_from_directory('D:\\\\face_cnn\\\\training',
                                               target_size=(150,150),
                                               batch_size=32,
                                               class_mode ='categorical')
test_set=train_datagen.flow_from_directory('D:\\\\face_cnn\\\\test',
                                               target_size=(150,150),
                                               batch_size=32,
                                               class_mode ='categorical')
